...
# # It uses a modern, unified API proxy configuration.
...
#     # --- NEW: Unified API Proxy Block ---
#     # This single location block handles EVERYTHING for our backend.
#     # It correctly proxies HTTP requests and upgrades WebSocket connections.
#     location /api/ {
